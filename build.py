...
LIBRARIES: List[bs.Library] = [
    {
        "name": "fake",
        "sources": ["src/fakelib/lib.c"],
        "include_dirs": ["src/fakelib"],
    },
]
...
def main():
    parser = argparse.ArgumentParser(description="Build radproject")
    parser.add_argument(
    ...
    test_binaries, mj_files = bs.build_targets(
        targets, TEST_TARGETS, build_dir, args.gcc, warnings, clang_warnings, mode_flags, built_libs
    )
